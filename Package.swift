...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "GraphAdjMat", targets: ["GraphAdjMat"]),
    ...
    targets: [
        ...
        .executableTarget(name: "GraphAdjMat", dependencies: ["Utils"], path: "Sources/DataStructure", sources: ["GraphAdjMat.swift"]),
