...
let myfiles: [String] = [
    ...
    "./Sources/Leetcode/binary-tree-inorder-traversal.swift",
    "./Sources/Leetcode/binary-tree-level-order-traversal.swift",
    "./Sources/Leetcode/binary-tree-maximum-path-sum.swift",
    "./Sources/Leetcode/binary-tree-postorder-traversal.swift",
    "./Sources/Leetcode/binary-tree-preorder-traversal.swift",
    "./Sources/Leetcode/construct-binary-tree-from-preorder-and-inorder-traversal.swift",
    "./Sources/Leetcode/construct-binary-tree-from-inorder-and-postorder-traversal.swift",
    "./Sources/Leetcode/construct-binary-tree-from-preorder-and-postorder-traversal.swift",
    "./Sources/Leetcode/insert-into-a-binary-search-tree.swift",
    "./Sources/Leetcode/invert-binary-tree.swift",
